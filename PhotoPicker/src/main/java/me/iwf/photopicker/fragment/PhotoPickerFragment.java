...
public class PhotoPickerFragment extends Fragment {
    public static final int PERMISS_CODE_CAMERA = 11;
    public static final int PERMISS_CODE_STORAGE = 12;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        photoGridAdapter.setOnCameraClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                PermissionsUtil.requestPermissions(getActivity(), PhotoPickerFragment.this,
                        PERMISS_CODE_CAMERA, Manifest.permission.CAMERA,
...
//                                            ImageCaptureManager.REQUEST_TAKE_PHOTO);
                                    ...
                                    PermissionsUtil.requestPermissions(getActivity(), PhotoPickerFragment.this,
                                            PERMISS_CODE_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE,null);
                                    e.printStackTrace();
                                }
                            }
                        });
